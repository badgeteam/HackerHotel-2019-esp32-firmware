...
#define BADGE_PINS_H
	...
	#include "sdkconfig.h"
	...
	#elif defined(CONFIG_SHA_BADGE_V2) // Badge revision 0.1.0
		...
		#define FXL6408_PIN_NUM_LEDS     2 // FXL6408_PIN_NUM_LEDS also used for SD?
	...
	#elif defined(CONFIG_SHA_BADGE_V3) // Badge revision 1.0.x
		#define PIN_NUM_LEDS         32
		#define PIN_NUM_BUTTON_FLASH  0
		#define PIN_NUM_EPD_CLK      18
		#define PIN_NUM_EPD_MOSI      5
	...
	#elif defined(CONFIG_SHA_BADGE_V3_LITE) // Badge revision 1.0.x, but without the MPR121
		#define PIN_NUM_LEDS         32
		#define PIN_NUM_BUTTON_FLASH  0
		#define PIN_NUM_EPD_CLK      18
		#define PIN_NUM_EPD_MOSI      5
	...
	#elif defined(CONFIG_DISOBEY) //Disobey 2019
		#define PIN_NUM_BUTTON_FLASH      0
