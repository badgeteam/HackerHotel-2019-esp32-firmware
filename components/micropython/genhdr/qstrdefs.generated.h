...
QDEF(MP_QSTR_ARROW_DOWN, (const byte*)"\xf1\x80\x0a" "ARROW_DOWN")
QDEF(MP_QSTR_ARROW_LEFT, (const byte*)"\x58\xb7\x0a" "ARROW_LEFT")
QDEF(MP_QSTR_ARROW_RIGHT, (const byte*)"\xc3\x9a\x0b" "ARROW_RIGHT")
QDEF(MP_QSTR_ARROW_UP, (const byte*)"\xe6\x75\x08" "ARROW_UP")
...
QDEF(MP_QSTR_BTN_A, (const byte*)"\x03\xdc\x05" "BTN_A")
QDEF(MP_QSTR_BTN_B, (const byte*)"\x00\xdc\x05" "BTN_B")
QDEF(MP_QSTR_BTN_FLASH, (const byte*)"\x72\x86\x09" "BTN_FLASH")
QDEF(MP_QSTR_BTN_SELECT, (const byte*)"\xca\xbf\x0a" "BTN_SELECT")
QDEF(MP_QSTR_BTN_START, (const byte*)"\x02\x06\x09" "BTN_START")
...
QDEF(MP_QSTR_Button, (const byte*)"\xd3\xe2\x06" "Button")
...
QDEF(MP_QSTR_CENTERTOP, (const byte*)"\xe5\xf2\x09" "CENTERTOP")
...
QDEF(MP_QSTR_Checkbox, (const byte*)"\x36\x81\x08" "Checkbox")
QDEF(MP_QSTR_Container, (const byte*)"\x82\x64\x09" "Container")
...
QDEF(MP_QSTR_ELLIPSE, (const byte*)"\xef\x68\x07" "ELLIPSE")
...
QDEF(MP_QSTR_Font, (const byte*)"\x76\xb0\x04" "Font")
QDEF(MP_QSTR_GRAY, (const byte*)"\x08\xc6\x04" "GRAY")
QDEF(MP_QSTR_GREEN, (const byte*)"\xde\x98\x05" "GREEN")
QDEF(MP_QSTR_GREYSCALE, (const byte*)"\x74\x0d\x09" "GREYSCALE")
...
QDEF(MP_QSTR_Imagebox, (const byte*)"\xf7\xda\x08" "Imagebox")
...
QDEF(MP_QSTR_JOY_DOWN, (const byte*)"\x94\x0f\x08" "JOY_DOWN")
QDEF(MP_QSTR_JOY_LEFT, (const byte*)"\x3d\x67\x08" "JOY_LEFT")
QDEF(MP_QSTR_JOY_RIGHT, (const byte*)"\xc6\xbf\x09" "JOY_RIGHT")
QDEF(MP_QSTR_JOY_UP, (const byte*)"\xc3\x99\x06" "JOY_UP")
QDEF(MP_QSTR_KeyError, (const byte*)"\xea\x00\x08" "KeyError")
QDEF(MP_QSTR_Keyboard, (const byte*)"\x48\x02\x08" "Keyboard")
QDEF(MP_QSTR_KeyboardInterrupt, (const byte*)"\xaf\xe2\x11" "KeyboardInterrupt")
QDEF(MP_QSTR_LEFT, (const byte*)"\x9e\x6d\x04" "LEFT")
QDEF(MP_QSTR_LEFTTOP, (const byte*)"\xf5\x82\x07" "LEFTTOP")
...
QDEF(MP_QSTR_LUT_DEFAULT, (const byte*)"\x3c\xd9\x0b" "LUT_DEFAULT")
QDEF(MP_QSTR_LUT_FASTER, (const byte*)"\xc0\x44\x0a" "LUT_FASTER")
QDEF(MP_QSTR_LUT_FASTEST, (const byte*)"\xb5\xdc\x0b" "LUT_FASTEST")
QDEF(MP_QSTR_LUT_FULL, (const byte*)"\xc4\x62\x08" "LUT_FULL")
QDEF(MP_QSTR_LUT_MAX, (const byte*)"\x83\x59\x07" "LUT_MAX")
QDEF(MP_QSTR_LUT_NORMAL, (const byte*)"\xa4\x8b\x0a" "LUT_NORMAL")
QDEF(MP_QSTR_Label, (const byte*)"\x63\x07\x05" "Label")
QDEF(MP_QSTR_List, (const byte*)"\x07\xc1\x04" "List")
...
QDEF(MP_QSTR_RIGHTTOP, (const byte*)"\x8e\xfb\x08" "RIGHTTOP")
QDEF(MP_QSTR_ROLES, (const byte*)"\x62\x44\x05" "ROLES")
QDEF(MP_QSTR_ROUNDED, (const byte*)"\x66\xbb\x07" "ROUNDED")
...
QDEF(MP_QSTR_Style, (const byte*)"\xf2\x53\x05" "Style")
...
QDEF(MP_QSTR_Textbox, (const byte*)"\xad\x0c\x07" "Textbox")
...
QDEF(MP_QSTR_add_item, (const byte*)"\x0e\xf4\x08" "add_item")
...
QDEF(MP_QSTR_assign_image, (const byte*)"\xfc\xa6\x0c" "assign_image")
...
QDEF(MP_QSTR_attach_input, (const byte*)"\xe7\x71\x0c" "attach_input")
...
QDEF(MP_QSTR_background, (const byte*)"\xab\x6b\x0a" "background")
QDEF(MP_QSTR_backspace, (const byte*)"\x6a\x1f\x09" "backspace")
QDEF(MP_QSTR_badge, (const byte*)"\x80\xcc\x05" "badge")
QDEF(MP_QSTR_baseline_x, (const byte*)"\x39\x52\x0a" "baseline_x")
QDEF(MP_QSTR_baseline_y, (const byte*)"\x38\x52\x0a" "baseline_y")
QDEF(MP_QSTR_battery_charge_status, (const byte*)"\x86\x85\x15" "battery_charge_status")
QDEF(MP_QSTR_battery_volt_sense, (const byte*)"\xe7\xff\x12" "battery_volt_sense")
...
QDEF(MP_QSTR_char_count, (const byte*)"\x21\x96\x0a" "char_count")
QDEF(MP_QSTR_char_range_count, (const byte*)"\x21\x7d\x10" "char_range_count")
QDEF(MP_QSTR_char_ranges, (const byte*)"\x0e\x49\x0b" "char_ranges")
QDEF(MP_QSTR_chdir, (const byte*)"\xb1\xb2\x05" "chdir")
QDEF(MP_QSTR_checked, (const byte*)"\xc2\x10\x07" "checked")
...
QDEF(MP_QSTR_cursor_pos, (const byte*)"\xbc\xa0\x0a" "cursor_pos")
...
QDEF(MP_QSTR_demo, (const byte*)"\xe6\xeb\x04" "demo")
QDEF(MP_QSTR_deque, (const byte*)"\x05\x99\x05" "deque")
QDEF(MP_QSTR_destroy, (const byte*)"\x47\xe0\x07" "destroy")
QDEF(MP_QSTR_detach_input, (const byte*)"\x13\xc9\x0c" "detach_input")
...
QDEF(MP_QSTR_dict_entry_count, (const byte*)"\x88\x57\x10" "dict_entry_count")
QDEF(MP_QSTR_dict_view, (const byte*)"\x2d\xa9\x09" "dict_view")
QDEF(MP_QSTR_dictionary_data, (const byte*)"\x32\x8b\x0f" "dictionary_data")
QDEF(MP_QSTR_dictionary_offsets, (const byte*)"\xbc\x94\x12" "dictionary_offsets")
...
QDEF(MP_QSTR_disable_draw, (const byte*)"\x4e\x32\x0c" "disable_draw")
...
QDEF(MP_QSTR_display_image, (const byte*)"\xc7\x8f\x0d" "display_image")
QDEF(MP_QSTR_display_raw, (const byte*)"\xa4\x95\x0b" "display_raw")
...
QDEF(MP_QSTR_dump_mem_allocs, (const byte*)"\xb2\x2d\x0f" "dump_mem_allocs")
...
QDEF(MP_QSTR_eink_busy, (const byte*)"\x0e\xb9\x09" "eink_busy")
QDEF(MP_QSTR_eink_busy_wait, (const byte*)"\x1a\xd8\x0e" "eink_busy_wait")
QDEF(MP_QSTR_eink_deep_sleep, (const byte*)"\xb7\x22\x0f" "eink_deep_sleep")
QDEF(MP_QSTR_eink_display_raw, (const byte*)"\x92\x5f\x10" "eink_display_raw")
QDEF(MP_QSTR_eink_init, (const byte*)"\x29\xbd\x09" "eink_init")
QDEF(MP_QSTR_eink_png, (const byte*)"\xaa\x9d\x08" "eink_png")
QDEF(MP_QSTR_eink_png_info, (const byte*)"\x9b\x59\x0d" "eink_png_info")
QDEF(MP_QSTR_eink_wakeup, (const byte*)"\x8e\x17\x0b" "eink_wakeup")
QDEF(MP_QSTR_ellipse, (const byte*)"\x0f\xdc\x07" "ellipse")
QDEF(MP_QSTR_enable, (const byte*)"\x04\xde\x06" "enable")
QDEF(MP_QSTR_enable_draw, (const byte*)"\x7b\x81\x0b" "enable_draw")
...
QDEF(MP_QSTR_fallback_character, (const byte*)"\xef\xb0\x12" "fallback_character")
QDEF(MP_QSTR_file, (const byte*)"\xc3\x34\x04" "file")
QDEF(MP_QSTR_fileno, (const byte*)"\x82\x76\x06" "fileno")
QDEF(MP_QSTR_fill_arc, (const byte*)"\x45\x18\x08" "fill_arc")
QDEF(MP_QSTR_fill_circle, (const byte*)"\xe7\x97\x0b" "fill_circle")
QDEF(MP_QSTR_fill_ellipse, (const byte*)"\xdf\x88\x0c" "fill_ellipse")
QDEF(MP_QSTR_fill_polygon, (const byte*)"\xf9\x7d\x0c" "fill_polygon")
QDEF(MP_QSTR_fill_rounded_box, (const byte*)"\xfc\x13\x10" "fill_rounded_box")
QDEF(MP_QSTR_filter, (const byte*)"\x25\xbe\x06" "filter")
QDEF(MP_QSTR_find, (const byte*)"\x00\x34\x04" "find")
QDEF(MP_QSTR_first_char, (const byte*)"\xf8\x6a\x0a" "first_char")
...
QDEF(MP_QSTR_fonts_dump, (const byte*)"\xb6\xce\x0a" "fonts_dump")
QDEF(MP_QSTR_fonts_list, (const byte*)"\x78\xe1\x0a" "fonts_list")
QDEF(MP_QSTR_fonts_load, (const byte*)"\x3c\xda\x0a" "fonts_load")
QDEF(MP_QSTR_format, (const byte*)"\x26\x33\x06" "format")
QDEF(MP_QSTR_freedomgfx, (const byte*)"\x0e\xc3\x0a" "freedomgfx")
...
QDEF(MP_QSTR_full_name, (const byte*)"\x6e\xe3\x09" "full_name")
...
QDEF(MP_QSTR_get_char_width, (const byte*)"\x2d\x3b\x0e" "get_char_width")
QDEF(MP_QSTR_get_lut, (const byte*)"\x81\x29\x07" "get_lut")
...
QDEF(MP_QSTR_get_string_width, (const byte*)"\x00\xb0\x10" "get_string_width")
...
QDEF(MP_QSTR_glyph_data, (const byte*)"\x60\xa6\x0a" "glyph_data")
QDEF(MP_QSTR_glyph_offsets, (const byte*)"\xae\x60\x0d" "glyph_offsets")
QDEF(MP_QSTR_gmtime, (const byte*)"\x5a\x8e\x06" "gmtime")
QDEF(MP_QSTR_group, (const byte*)"\xba\xb0\x05" "group")
QDEF(MP_QSTR_hall_sens_read, (const byte*)"\xd5\x3d\x0e" "hall_sens_read")
...
QDEF(MP_QSTR_i2c_read_reg, (const byte*)"\xff\x58\x0c" "i2c_read_reg")
QDEF(MP_QSTR_i2c_write_reg, (const byte*)"\xf0\x14\x0d" "i2c_write_reg")
...
QDEF(MP_QSTR_input_attach, (const byte*)"\x87\x34\x0c" "input_attach")
QDEF(MP_QSTR_input_init, (const byte*)"\x96\x88\x0a" "input_init")
...
QDEF(MP_QSTR_justification, (const byte*)"\x25\xaa\x0d" "justification")
QDEF(MP_QSTR_justifyCenter, (const byte*)"\x80\xe6\x0d" "justifyCenter")
QDEF(MP_QSTR_justifyLeft, (const byte*)"\x90\xfc\x0b" "justifyLeft")
QDEF(MP_QSTR_justifyRight, (const byte*)"\xeb\x02\x0c" "justifyRight")
...
QDEF(MP_QSTR_leds_disable, (const byte*)"\x10\xb9\x0c" "leds_disable")
QDEF(MP_QSTR_leds_enable, (const byte*)"\x25\x7d\x0b" "leds_enable")
QDEF(MP_QSTR_leds_init, (const byte*)"\x3e\x0f\x09" "leds_init")
QDEF(MP_QSTR_leds_send_data, (const byte*)"\xd7\x05\x0e" "leds_send_data")
...
QDEF(MP_QSTR_max_x_advance, (const byte*)"\xf3\x1c\x0d" "max_x_advance")
QDEF(MP_QSTR_maxlen, (const byte*)"\x56\x18\x06" "maxlen")
...
QDEF(MP_QSTR_min_x_advance, (const byte*)"\x6d\xfe\x0d" "min_x_advance")
...
QDEF(MP_QSTR_mount_bpp, (const byte*)"\xb5\x5c\x09" "mount_bpp")
QDEF(MP_QSTR_mount_root, (const byte*)"\xd1\x7b\x0a" "mount_root")
QDEF(MP_QSTR_mount_sdcard, (const byte*)"\x34\x29\x0c" "mount_sdcard")
QDEF(MP_QSTR_mountsd, (const byte*)"\x5f\x1e\x07" "mountsd")
QDEF(MP_QSTR_mpr121_get_touch_info, (const byte*)"\x1a\xe2\x15" "mpr121_get_touch_info")
...
QDEF(MP_QSTR_nvs_erase_key, (const byte*)"\x99\x21\x0d" "nvs_erase_key")
QDEF(MP_QSTR_nvs_get_str, (const byte*)"\x2d\x5d\x0b" "nvs_get_str")
QDEF(MP_QSTR_nvs_get_u16, (const byte*)"\xca\x5c\x0b" "nvs_get_u16")
QDEF(MP_QSTR_nvs_get_u8, (const byte*)"\x75\xad\x0a" "nvs_get_u8")
QDEF(MP_QSTR_nvs_getint, (const byte*)"\xb4\x12\x0a" "nvs_getint")
QDEF(MP_QSTR_nvs_getstr, (const byte*)"\x72\x1b\x0a" "nvs_getstr")
QDEF(MP_QSTR_nvs_set_str, (const byte*)"\x39\x89\x0b" "nvs_set_str")
QDEF(MP_QSTR_nvs_set_u16, (const byte*)"\xde\x67\x0b" "nvs_set_u16")
QDEF(MP_QSTR_nvs_set_u8, (const byte*)"\xe1\x0a\x0a" "nvs_set_u8")
...
QDEF(MP_QSTR_orientation, (const byte*)"\x53\x32\x0b" "orientation")
...
QDEF(MP_QSTR_png, (const byte*)"\x1c\x73\x03" "png")
QDEF(MP_QSTR_png_info, (const byte*)"\x2d\x55\x08" "png_info")
...
QDEF(MP_QSTR_power_init, (const byte*)"\x5f\x69\x0a" "power_init")
QDEF(MP_QSTR_power_leds_disable, (const byte*)"\x50\x6f\x12" "power_leds_disable")
QDEF(MP_QSTR_power_leds_enable, (const byte*)"\xe5\x5a\x11" "power_leds_enable")
QDEF(MP_QSTR_power_sdcard_disable, (const byte*)"\x8d\x7a\x14" "power_sdcard_disable")
QDEF(MP_QSTR_power_sdcard_enable, (const byte*)"\x98\xfe\x13" "power_sdcard_enable")
...
QDEF(MP_QSTR_rawrepl, (const byte*)"\xaa\x8d\x07" "rawrepl")
...
QDEF(MP_QSTR_remove_bpp_partition, (const byte*)"\xa3\x0d\x14" "remove_bpp_partition")
QDEF(MP_QSTR_remove_item, (const byte*)"\x09\xe2\x0b" "remove_item")
...
QDEF(MP_QSTR_rle_entry_count, (const byte*)"\xe9\xc7\x0f" "rle_entry_count")
...
QDEF(MP_QSTR_rounded_box, (const byte*)"\x2c\xf0\x0b" "rounded_box")
...
QDEF(MP_QSTR_rtc_get_reset_reason, (const byte*)"\x18\x6b\x14" "rtc_get_reset_reason")
...
QDEF(MP_QSTR_safe_mode, (const byte*)"\x88\xa8\x09" "safe_mode")
...
QDEF(MP_QSTR_selected_index, (const byte*)"\x4d\xba\x0e" "selected_index")
QDEF(MP_QSTR_selected_key, (const byte*)"\x84\x92\x0c" "selected_key")
QDEF(MP_QSTR_selected_text, (const byte*)"\x6e\x8d\x0d" "selected_text")
QDEF(MP_QSTR_send, (const byte*)"\xb9\x76\x04" "send")
QDEF(MP_QSTR_send_tab, (const byte*)"\x11\x46\x08" "send_tab")
...
QDEF(MP_QSTR_set_background, (const byte*)"\x36\x09\x0e" "set_background")
QDEF(MP_QSTR_set_default_font, (const byte*)"\x5f\x9a\x10" "set_default_font")
QDEF(MP_QSTR_set_default_style, (const byte*)"\x3b\xda\x11" "set_default_style")
QDEF(MP_QSTR_set_disabled, (const byte*)"\x88\x9e\x0c" "set_disabled")
QDEF(MP_QSTR_set_enabled, (const byte*)"\x1d\x48\x0b" "set_enabled")
QDEF(MP_QSTR_set_focus, (const byte*)"\x34\x40\x09" "set_focus")
QDEF(MP_QSTR_set_lut, (const byte*)"\x95\x9d\x07" "set_lut")
...
QDEF(MP_QSTR_short_name, (const byte*)"\x0f\xad\x0a" "short_name")
...
QDEF(MP_QSTR_string, (const byte*)"\x70\xe5\x06" "string")
QDEF(MP_QSTR_string_box, (const byte*)"\xda\x13\x0a" "string_box")
...
QDEF(MP_QSTR_temperature_sens_read, (const byte*)"\x70\x5c\x15" "temperature_sens_read")
QDEF(MP_QSTR_text, (const byte*)"\x98\xaf\x04" "text")
QDEF(MP_QSTR_thickline, (const byte*)"\x36\x43\x09" "thickline")
...
QDEF(MP_QSTR_ugfx, (const byte*)"\x69\x45\x04" "ugfx")
...
QDEF(MP_QSTR_unmount_sdcard, (const byte*)"\x8f\x71\x0e" "unmount_sdcard")
...
QDEF(MP_QSTR_usb_volt_sense, (const byte*)"\x0e\x48\x0e" "usb_volt_sense")
...
QDEF(MP_QSTR_vibrator_activate, (const byte*)"\xa4\x55\x11" "vibrator_activate")
QDEF(MP_QSTR_vibrator_init, (const byte*)"\xc7\xc7\x0d" "vibrator_init")
QDEF(MP_QSTR_visible, (const byte*)"\x8b\x6a\x07" "visible")
...
QDEF(MP_QSTR_wdt_reset, (const byte*)"\x48\xa4\x09" "wdt_reset")
QDEF(MP_QSTR_wdt_start, (const byte*)"\xdd\x9f\x09" "wdt_start")
QDEF(MP_QSTR_wdt_stop, (const byte*)"\x45\xce\x08" "wdt_stop")
